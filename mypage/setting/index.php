                    ...
                    <table class="table01 mb30">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <textarea name="" id="" cols="30" rows="10" class="input-type01"></textarea>
                          </td>
                        </tr>
                        <tr>
                          <th>E-mail
                        ...
                        <tr>
                          <th class="type1">パスワード
                          </th>
                          <td>
                            <div class="txt">現在のパスワード</div>
                            <input type="password" id="tripDeparture" class="chkrequired chkmin8 chkmax32 input-type01 mb10">
                            <div class="txt">新しいパスワード</div>
                            <input type="password" id="tripDeparture" class="chkrequired chkmin8 chkmax32 input-type01 mb10">
                            <div class="txt">再入力</div>
                            <input type="password" id="tripDeparture" class="chkrequired chkmin8 chkmax32 input-type01">
                          </td>
                        </tr>
                      </tbody>
                    </table>
                    <div class="btngroup"><input type="submit" value="更新" class="btn07"></div>
                  </form>
                  </section>
                  <section class="section">
                    <h2 class="h3-ttl01">Instagramと連携</h2>
                    <p class="txt-set01">投稿するにはInstagramとの連携が必須になります。</p>
                    <a href="#" class="btn-insta"><img src="/images/btn-instagram.gif" width="208" height="60" alt="Instagramと連携"></a>			
                  </section>
              </div>
              <div id="sub">
                <div class="user-area">
                  <div class="setting"><a href="#">プロフィールを編集する</a></div>
                  <div class="user-info">
                    <div class="user-img">
