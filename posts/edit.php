		...
		<div class="inner">
			<div id="main">
				<form id="post-add-form" action="confirm.php">
					...
					<p><input type="text" id="tripTitle" class="chkrequired chkmin8 chkmax32 input-type01"></p>
					<h2>出発日<span class="req">*</span></h2>
					<p><input type="text" id="tripDeparture" class="chkrequired chkmin8 chkmax32 input-type01"></p>
					<h2>旅の目的<span class="req">*</span><span class="attention">複数選択可。訪問した地域を選択してください.</span></h2>
					<div id="tripType">
						<input type="radio" name="tripType" value="家族旅行" id="tripType01"><label for="tripType01">家族旅行</label> 
						<input type="radio" name="tripType" value="社員旅行" id="tripType02"> <label for="tripType02">社員旅行</label>
						<input type="radio" name="tripType" value="卒業旅行" id="tripType03"> <label for="tripType03">卒業旅行</label>
						<input type="radio" name="tripType" value="新婚旅行" id="tripType04"> <label for="tripType04">新婚旅行</label>
						<input type="radio" name="tripType" value="女子旅" id="tripType05"> <label for="tripType05">女子旅</label>
						<input type="radio" name="tripType" value="友人と" id="tripType06"> <label for="tripType06">友人と</label>
					</div>
					...
					<article id="main-contents">
						<section class="day1">
							...
							<p><input type="text" id="eventTitle1" class="chkmax32 chkrequired input-type01"></p>
							<ul class="img-select">
								<li>動画・画像を掲載する</li>
								<li>動画・画像を掲載する</li>
							</ul>
							<h2>コメントを入力<span class="attention">150文字以内で入力してください 。</span></h2>	
							<div class="mb30"><textarea name="eventCommnet1" id="eventComment1" class="chkmax150 chkrequired input-type02" rows="5"></textarea></div>
							<h2>スポット名を入力</h2>
							<div class="mb30"><textarea name="eventSpot1"  id="eventSpot1" class="chkmax150 chkrequired input-type02" rows="5"></textarea></div>
						</section>
					</article>
