        ...
        <div id="main">
          <form id="post-add-form" action="confirm.php">
            <section class="section">
              <h1 class="h1-ttl01">コンテンツを編集する</h1>
  ...
  $num = $num+1; if($value == $_POST["pref_return"]){
    ...
    echo "<label for='local".$num."'><input type='checkbox' name='local' id='local".$num."' value='$value'>".$value."</label>"; 
            ...
            <div class="section event-area">
              <!-- idに変更 3日1:50 -->
              <section id="day1" class="post-module02">
                ...
                <div class="post-module02-event">
                  ...
                  <div class="post-module02-item">
                    ...
                    <div class="input-area01 event-map">
                      ...
                      <input type="text" name="eventMap1" id="eventMap1" class="input-type02 chkmax150" rows="1" aria-haspopup="true" aria-expanded="false" aria-readonly="false" data-lat="35.021004" data-lng="135.755608" />
                      <!-- ここまで修正箇所 1日 22:30 -->
                    </div>
                  </div>
